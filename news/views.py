...
# def load_news():
#
#     for news in parse()['Політика']:
#         for item in news:
#             a = News.objects.create(title=news['title'],
#                                 content=news['content'],
#                                 category_id=1)
#             a.save()
#
#     for news in parse()['Культура']:
#         for item in news:
#             a = News.objects.create(title=news['title'],
#                                 content=news['content'],
#                                 category_id=2)
